-- Adiciona campo unidade_geradora à view vendas_atribuidas
-- DROP necessário porque nova coluna muda a posição das colunas existentes
...
-- Índice para filtros por unidade_geradora
CREATE INDEX IF NOT EXISTS idx_rd_vendas_unidade_geradora ON rd_vendas ((data->>'unidade_geradora'));
