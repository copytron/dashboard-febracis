-- Remove deduplicação incorreta da view vendas_atribuidas
-- A dedup por (nome_venda, valor) removia ~4.357 registros válidos
-- O UPSERT em rd_vendas já garante unicidade por id_venda (0 duplicatas reais)
